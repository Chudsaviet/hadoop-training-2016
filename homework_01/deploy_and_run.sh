...
yarn jar target/tk-homework1-1.0.jar org.tk.hw1.Client hdfs:///apps/tk_hw1/user.profile.tags.us.txt hdfs:///apps/tk_hw1/result 30 hdfs:///apps/tk_hw1/tk-homework1-1.0.jar
