...
yarn jar target/homework03-1.0.jar org.tkorostelev.homework03.Point03 hdfs:///apps/tk_hw3_p3/tags.txt.gz hdfs:///dataset/stream.*.txt.gz hdfs:///apps/tk_hw3_p3/result
rm ./part-r-00000 || true
hdfs dfs -copyToLocal /apps/tk_hw3_p3/result/part-r-00000 ./
cat part-r-00000