...
CREATE TABLE ALL_DEVICES_ALL_DATES AS
SELECT
    dev.DEVICE,
    dt.DATE_VAL
FROM
...
CREATE TABLE ALL_USERS_ALL_DEVICES_ALL_DATES AS
SELECT
    u.IPINYOU_ID,
    dd.DEVICE,
    dd.DATE_VAL
...
CREATE TABLE USER_ALLDATES_ALLDEVICES_CLICKS AS
SELECT
    aaa.IPINYOU_ID,
    aaa.DEVICE,
...
CREATE TABLE USER_DEVICE_DAY_SEGMENT AS
SELECT
    IPINYOU_ID,
    DEVICE,
    CLICK_DT,
