...
DROP VIEW IF EXISTS ALL_USERS_ALL_DEVICES_ALL_DATES;
CREATE VIEW ALL_USERS_ALL_DEVICES_ALL_DATES AS
SELECT
    u.IPINYOU_ID,
    dev.DEVICE,
    dt.DATE_VAL
...
DROP VIEW IF EXISTS USER_ALLDATES_ALLDEVICES_CLICKS;
CREATE VIEW USER_ALLDATES_ALLDEVICES_CLICKS AS
SELECT
    aaa.IPINYOU_ID,
    aaa.DEVICE,
